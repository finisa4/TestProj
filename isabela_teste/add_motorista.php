			...
			<form id="add_motorista">
				<div class="card mt-3 shadow-sm">
					<div class="card-header">
						<h5 class="card-title text-center">Cadastrar um novo motorista</h5>
					</div>
						...
						<div class="row">
							<div class="col-sm-6" style="display: inline-block;">
								<div class="form-group">
									...
									<input type="text" maxlength="250" class="form-control" id="nome" name="nome" aria-describedby="emailHelp" placeholder="Digite o nome completo">
							...
							<div class="col-sm-6" style="display: inline-block;">
								...
								<div class="form-group">
									<label for="motoCarro">Modelo do Carro</label>
									<input type="text" maxlength="255" class="form-control" id="carro" name="carro" placeholder="Descreva aqui o modelo do carro">
									<small id="carroHelp" class="form-text text-white help">&nbsp;</small>
								</div>
								<div class="form-group">
									<label>Status</label>
									<div class="custom-control custom-radio">
										<input type="radio" id="sAtivo" name="status" class="custom-control-input" value="A">
										<label class="custom-control-label" for="sAtivo">Ativo</label>
									</div>
									<div class="custom-control custom-radio">
										<input type="radio" id="sInativo" name="status" class="custom-control-input" value="I">
										<label class="custom-control-label" for="sInativo">Inativo</label>
									</div>
									<small id="statusHelp" class="form-text text-white help">&nbsp;</small>
								</div>
							</div>
						</div>
						<div class="row justify-content-md-center">
							<div class="col col-lg-4 pl-5 pr-5">
      							<input type="button" class="btn btn-primary btn-block" id="submitMotorista" value="Enviar">
